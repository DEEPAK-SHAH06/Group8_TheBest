// Write a Java program that simulates an ATM PIN 
// verification system.
// The program should have a correct PIN stored (for example, 1234) and
//  allow the user up to three attempts to enter the correct PIN.
